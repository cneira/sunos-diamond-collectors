...
class TestFMACollector(CollectorTestCase):
    ...
    def test_collate_fmstats(self):
        ...
        set_keys = sorted(('cpumem-retire', 'disk-diagnosis',
                    'disk-transport', 'eft', 'endurance-transport',
                    'enum-transport', 'ext-event-transport',
                    'fabric-xlate', 'fdd-msg', 'fmd-self-diagnosis',
                    'fru-monitor', 'io-retire', 'non-serviceable',
                    'sas-cabling', 'sensor-transport',
                    'ses-log-transport', 'software-diagnosis',
                    'software-response', 'sysevent-transport',
